...
export default function AccountRecovery() {
  ...
  return (
    <div className="flex justify-around flex-col md:flex-row gap-5   items-center h-screen bg-quotee-100 p-10 text-quotee-600">
      ...
      <div className="flex justify-center gap-10 items-center flex-col w-full md:w-1/3 h-[500px] sm:h-screen bg-quotee-50 border-2 border-quotee-200 rounded-2xl md:rounded-none p-5">
